...
-- object: match_stats_pk | type: CONSTRAINT --
-- ALTER TABLE public.match_stats DROP CONSTRAINT IF EXISTS match_stats_pk CASCADE;
ALTER TABLE public.match_stats ADD CONSTRAINT match_stats_pk PRIMARY KEY (id);
-- ddl-end --
